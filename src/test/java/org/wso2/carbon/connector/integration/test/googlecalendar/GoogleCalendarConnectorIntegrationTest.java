...
public class GoogleCalendarConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        ...
        init("googlecalendar-connector-1.0.2-SNAPSHOT");
    ...
    public void testPatchCalendarWithNegativeCase() throws Exception {
        ...
        /**
     * Positive test case for updateCalendar method with mandatory parameters.
     */
    @Test(priority = 2,dependsOnMethods = {"testCreateCalendarWithMandatoryParameters","testGetCalendarWithMandatoryParameters"}, groups = {"wso2.esb"}, description = "googlecalendar {updateCalendar} integration test with mandatory parameters.")
    public void testUpdateCalendarWithMandatoryParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateCalendar");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateCalendar_mandatory.txt", parametersMap);
        Thread.sleep(3000);
        String apiEndPoint = "https://www.googleapis.com/calendar/v3/calendars/" + parametersMap.get("calendarId") + "?fields=description,id,kind,location,summary,timeZone";
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        ...
        /**
     * Positive test case for updateCalendar method with optional parameters.
     */
    @Test(dependsOnMethods = {"testCreateCalendarWithMandatoryParameters"}, groups = {"wso2.esb"}, description = "googlecalendar {updateCalendar} integration test with optional parameters.")
    public void testUpdateCalendarWithOptionalParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateCalendar");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateCalendar_optional.txt", parametersMap);
        Thread.sleep(3000);
        String apiEndPoint = "https://www.googleapis.com/calendar/v3/calendars/" + parametersMap.get("calendarId") + "?fields=description,id,kind,location,summary,timeZone";
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        ...
        /**
     * Negative test case for updateCalendar method.
     */
    @Test(dependsOnMethods = {"testCreateCalendarWithMandatoryParameters"}, groups = {"wso2.esb"}, description = "googlecalendar {updateCalendar} integration test with negative case.")
    public void testUpdateCalendarWithNegativeCase() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateCalendar");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateCalendar_negative.txt", parametersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("error").get("message"), "Invalid Value");
    }
     ...
     */
    @Test(priority =4, dependsOnMethods = {"testClearCalendarWithNegativeCase"}, groups = {"wso2.esb"}, description = "googlecalendar {clearCalendar} integration test with mandatory parameters.")
    ...
    /**
     * Positive test case for updateCalendarEntry method with mandatory parameters.
     */
    @Test(dependsOnMethods = {"testCreateCalendarWithMandatoryParameters"}, priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {updateCalendarEntry} integration test with mandatory parameters.")
    public void testUpdateCalendarEntryWithMandatoryParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateCalendarEntry");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateCalendarEntry_mandatory.txt", parametersMap);
     ...
     */
    @Test(dependsOnMethods = {"testCreateCalendarWithMandatoryParameters"}, priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {updateCalendarEntry} integration test with optional parameters.")
    public void testUpdateCalendarEntryWithOptionalParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateCalendarEntry");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateCalendarEntry_optional.txt", parametersMap);
     ...
     */
    @Test(dependsOnMethods = {"testCreateCalendarWithMandatoryParameters"}, priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {updateCalendarEntry} integration test with negative case.")
    public void testUpdateCalendarEntryWithNegativeCase() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateCalendarEntry");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateCalendarEntry_negative.txt", parametersMap);
    ...
    /**
     * Positive test case for updateAcl method with mandatory parameters.
     */
    @Test(dependsOnMethods = {"testGetAclWithMandatoryParameters","testCreateAclWithMandatoryParameters"}, priority = 2, groups = {"wso2.esb"}, description = "googlecalendar {updateAcl} integration test with mandatory parameters.")
    public void testUpdateAclWithMandatoryParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateAcl");
        String apiEndPoint = "https://www.googleapis.com/calendar/v3/calendars/" + parametersMap.get("calendarId") + "/acl/" + parametersMap.get("ruleId");

        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateAcl_mandatory.txt", parametersMap);
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    /**
     * Negative test case for updateAcl method.
     */
    @Test(dependsOnMethods = {"testGetAclWithMandatoryParameters","testCreateAclWithMandatoryParameters"}, priority = 2, groups = {"wso2.esb"}, description = "googlecalendar {updateAcl} integration test with mandatory parameters.")
    public void testUpdateAclWithNegativeCase() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateAcl");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateAcl_negative.txt", parametersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("error").get("message"), "Missing scope type.");
    }
    ...
    public void testGetAclWithMandatoryParameters() throws Exception {
        ...
        final Object Value = apiRestResponse.getBody().getJSONObject("scope").get("value");
        connectorProperties.setProperty("value", (String) Value);
    ...
    public void testPatchEventsWithNegativeCase() throws Exception {
        ...
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        //Assert.assertEquals(esbRestResponse.getBody().getJSONObject("error").get("message"), "<Invalid value for: Invalid format: \"\"");
    ...
    /**
     * Positive test case for updateEvents method with mandatory parameters.
     */
    @Test(dependsOnMethods = {"testCreateEventWithMandatoryParameters"}, priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {updateEvents} integration test with mandatory parameters.")
    public void testUpdateEventsWithMandatoryParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateEvents");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateEvents_mandatory.txt", parametersMap);
    ...
    /**
     * Positive test case for updateEvents method with optional parameters.
     */
    @Test(dependsOnMethods = {"testCreateEventWithMandatoryParameters"}, priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {updateEvents} integration test with optional parameters.")
    public void testUpdateEventsWithOptionalParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateEvents");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateEvents_optional.txt", parametersMap);
    ...
    /**
     * Negative test case for updateEvents method.
     */
    @Test(dependsOnMethods = {"testCreateEventWithMandatoryParameters"}, priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {updateEvents} integration test with negative case.")
    public void testUpdateEventsWithNegativeCase() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:updateEvents");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateEvents_negative.txt", parametersMap);

        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("error").get("message"), "Missing end time.");
        Assert.assertTrue(esbRestResponse.getBody().getJSONObject("error").getJSONArray("errors").length() > 0);
    }
    ...
    /**
     * Positive test case for listSettings method with mandatory parameters.
     */
    @Test(priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {listSettings} integration test with mandatory parameters.")
    public void testListSettingsWithMandatoryParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:listSettings");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listSettings_mandatory.txt", parametersMap);
        final String ID = esbRestResponse.getBody().getJSONArray("items").getJSONObject(0).getString("id");

        connectorProperties.setProperty("setting", ID);

        // Get events from getEvent api call to compare against patched event
        String apiEndPoint = "https://www.googleapis.com/calendar/v3/users/me/settings";
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(esbRestResponse.getBody().get("etag").toString(), apiRestResponse.getBody().get("etag").toString());
    }

    /**
     * Positive test case for listSettings method with optional parameters.
     */
    @Test(priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {listSettings} integration test with optional parameters.")
    public void testListSettingsWithOptionalParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:listSettings");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listSettings_optional.txt", parametersMap);

        // Get events from getEvent api call to compare against patched event
        String apiEndPoint = "https://www.googleapis.com/calendar/v3/users/me/settings?maxResults=2";
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    /**
     * Negative test case for listSettings method.
     */
    @Test(priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {listSettings} integration test with negative case.")
    public void testListSettingsWithNegativeCase() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:listSettings");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listSettings_negative.txt", parametersMap);
     ...
     */
    @Test(dependsOnMethods = {"testListSettingsWithMandatoryParameters"}, priority = 2, groups = {"wso2.esb"}, description = "googlecalendar {getSettings} integration test with mandatory parameters.")
    public void testGetSettingsWithMandatoryParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:getSettings");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getSettings_mandatory.txt", parametersMap);

        String apiEndPoint = "https://www.googleapis.com/calendar/v3/users/me/settings/" + connectorProperties.getProperty("setting");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    /**
     * Negative test case for getSettings method.
     */
    @Test(priority = 1, groups = {"wso2.esb"}, description = "googlecalendar {getSettings} integration test with negative case.")
    public void testGetSettingsWithNegativeCase() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:getSettings");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getSettings_negative.txt", parametersMap);
